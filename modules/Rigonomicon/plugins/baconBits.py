...
baconBitsId = OpenMaya.MTypeId(0x0012aa01)
...
def nodeInitializer():
    ...
    baconBits.bitName = bitNameAttr.create("bitName", "bname", OpenMaya.MFnStringData.kString, bitNameAttrStr)
    bitNameAttr.setStorable(True)
    bitNameAttr.setKeyable(False)
    baconBits.addAttribute( baconBits.bitName )

    # bit Type
    bitTypeAttr = OpenMaya.MFnEnumAttribute()
    baconBits.bitType = bitTypeAttr.create("bitType", "btype", 0)
    ...
    baconBits.addAttribute( baconBits.bitType )

    # guide interface
    guideAttr = OpenMaya.MFnTypedAttribute()
    baconBits.guide = guideAttr.create("guide", "guide", OpenMaya.MFnStringData.kString)
    guideAttr.setStorable(True)
    guideAttr.setKeyable(True)
    guideAttr.setReadable(False)
    baconBits.addAttribute( baconBits.guide )
    ...
    baconBits.bitComponents = bitComponentsAttr.create("bitComponents", "bitComponents")
    ...
    baconBits.addAttribute( baconBits.bitComponents)
    # ------------------------------------------------------------

    # rig interface
    interfaceAttr = OpenMaya.MFnTypedAttribute()
    baconBits.interface = interfaceAttr.create("rig", "rig", OpenMaya.MFnStringData.kString)
    interfaceAttr.setStorable(True)
    interfaceAttr.setKeyable(True)
    interfaceAttr.setWritable(False)
    baconBits.addAttribute( baconBits.interface )
